...
- 本项目是 OpenGame × Astrocade 风格内部 MVP：用 prompt/brief 生成可玩的 HTML5 游戏，支持 Gallery、我的作品、详情播放、继续修改、Like、playCount。
- 优先级：真实生成链路可跑 > 产品闭环清楚 > 视觉精致；不要先做运营、账号、评论、创作者经济等非 MVP 能力。
